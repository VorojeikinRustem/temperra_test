...
lazyRequireTask('vendor_styles', './tasks/vendor_styles', {
  src: [
    'app/vendor/css/normalize.css',
      /*'app/vendor/css/magnific-popup.css',*/
  ],
  dst: 'build/css'
});
...
lazyRequireTask('vendor_scripts', './tasks/vendor_scripts', {
  src: [
    // 'app/vendor/js/jquery.magnific-popup.min.js',
    // 'app/vendor/js/jquery.cookie.js',
  ],
  dst: 'build/js/'
});
...
gulp.task('build', gulp.series(
  'clean',
  gulp.parallel('templates', 'styles', 'scripts', 'sprite', 'assets', 'vendor_styles')
));

gulp.task('default',  gulp.series(['templates', 'styles', 'scripts', 'sprite', 'assets']));
gulp.task('ss', gulp.parallel(['styles', 'scripts', 'vendor_styles']));
...
gulp.task('watch', () => {
  ...
  gulp.watch(['app/blocks/**/*.js', 'app/assets/scripts/**/*.js'], gulp.series('scripts'));
